...
const AccionBannerColor = () => {
    return (
        <div className="bg-verde w-full h-full flex flex-col items-center justify-center pl-[30px] pr-[30px] pt-[45px] pb-[45px] gap-[20px] lg:flex-row lg:gap-[50px]">
            ...
            <Link
                href="/contactanos"
                className="bg-transparent border-2 border-white tracking-wide w-[250px] leading-normal text-blancoTres  font-bold font-montserrat text-center pb-[15px] pt-[15px] pr-[10px] pl-[10px]">
                {' '}
                CONTÁCTANOS{' '}
            </Link>
        </div>
